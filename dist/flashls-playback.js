(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["FlashlsPlayback"] = factory(require("@clappr/core"));
	else
		root["FlashlsPlayback"] = factory(root["Clappr"]);
...
/***/ "./node_modules/@clappr/flash-playback/dist/flash-playback.js":
/*!********************************************************************!*\
  !*** ./node_modules/@clappr/flash-playback/dist/flash-playback.js ***!
  \********************************************************************/
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		module.exports = factory(__webpack_require__(/*! @clappr/core */ "@clappr/core"));
	else {}
})(window, function(__WEBPACK_EXTERNAL_MODULE__clappr_core__) {
return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ "./node_modules/css-loader/index.js!./node_modules/postcss-loader/lib/index.js!./node_modules/sass-loader/lib/loader.js!./src/playbacks/base_flash_playback/public/flash.scss":
/*!******************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/postcss-loader/lib!./node_modules/sass-loader/lib/loader.js!./src/playbacks/base_flash_playback/public/flash.scss ***!
  \******************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _base_flash_playback = __webpack_require__(/*! ./playbacks/base_flash_playback */ "./src/playbacks/base_flash_playback/base_flash_playback.js");

var _base_flash_playback2 = _interopRequireDefault(_base_flash_playback);

var _flash = __webpack_require__(/*! ./playbacks/flash */ "./src/playbacks/flash/flash.js");
...
var BaseFlashPlayback = function (_Playback) {
  ...
  BaseFlashPlayback.prototype.render = function render() {
    ...
    if (_core.Browser.isIE) {
      this.$('embed').remove();

      if (_core.Browser.isLegacyIE) this.$el.attr('classid', IE_CLASSID);
    }
  ...
  (0, _createClass3.default)(BaseFlashPlayback, [{
    ...
    key: 'template',
    get: function get() {
      return (0, _core.template)(_flash2.default);
    }
  }, {
    key: 'attributes',
    get: function get() {
      ...
      if (_core.Browser.isLegacyIE) type = '';
...
var content = __webpack_require__(/*! !../../../../node_modules/css-loader!../../../../node_modules/postcss-loader/lib!../../../../node_modules/sass-loader/lib/loader.js!./flash.scss */ "./node_modules/css-loader/index.js!./node_modules/postcss-loader/lib/index.js!./node_modules/sass-loader/lib/loader.js!./src/playbacks/base_flash_playback/public/flash.scss");
...
var seekStringToSeconds = _core.Utils.seekStringToSeconds; // Copyright 2014 Globo.com Player authors. All rights reserved.
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
...
var Flash = function (_BaseFlashPlayback) {
  ...
  (0, _createClass3.default)(Flash, [{
    ...
    key: 'swfPath',
    get: function get() {
      return (0, _core.template)(_Player2.default)({ baseUrl: this._baseUrl });
    }
  ...
  Flash.prototype._bootstrap = function _bootstrap() {
    ...
    if (this.el.playerPlay) {
      ...
      (0, _core.$)('<div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%" />').insertAfter(this.$el);
      if (this.getDuration() > 0) this._metadataLoaded();else _core.Mediator.once(this.uniqueId + ':timeupdate', this._metadataLoaded, this);
    } else {
      this._attempts = this._attempts || 0;
      if (++this._attempts <= MAX_ATTEMPTS) setTimeout(function () {
        return _this2._bootstrap();
      }, 50);else this.trigger(_core.Events.PLAYBACK_ERROR, { message: 'Max number of attempts reached' }, this.name);
    }
  };
  ...
  Flash.prototype._updateTime = function _updateTime() {
    this.trigger(_core.Events.PLAYBACK_TIMEUPDATE, { current: this.el.getPosition(), total: this.el.getDuration() }, this.name);
  };

  Flash.prototype._addListeners = function _addListeners() {
    _core.Mediator.on(this.uniqueId + ':progress', this._progress, this);
    _core.Mediator.on(this.uniqueId + ':timeupdate', this._updateTime, this);
    _core.Mediator.on(this.uniqueId + ':statechanged', this._checkState, this);
    _core.Mediator.on(this.uniqueId + ':flashready', this._bootstrap, this);
  };

  Flash.prototype.stopListening = function stopListening() {
    _BaseFlashPlayback.prototype.stopListening.call(this);
    _core.Mediator.off(this.uniqueId + ':progress');
    _core.Mediator.off(this.uniqueId + ':timeupdate');
    _core.Mediator.off(this.uniqueId + ':statechanged');
    _core.Mediator.off(this.uniqueId + ':flashready');
  };
  ...
  Flash.prototype._checkState = function _checkState() {
    if (this._isIdle || this._currentState === 'PAUSED') {
      ...
      this.trigger(_core.Events.PLAYBACK_TIMEUPDATE, { current: 0, total: this.el.getDuration() }, this.name);
  ...
  Flash.prototype._firstPlay = function _firstPlay() {
    ...
    if (this.el.playerPlay) {
      ...
      this.listenToOnce(this, _core.Events.PLAYBACK_BUFFERFULL, function () {
        return _this3._checkInitialSeek();
      });
      this._currentState = 'PLAYING';
    } else {
      this.listenToOnce(this, _core.Events.PLAYBACK_READY, this._firstPlay);
    }
  };
  ...
  Flash.prototype.play = function play() {
    ...
    if (this._currentState === 'PAUSED' || this._currentState === 'PLAYING_BUFFERING') {
      ...
      this.trigger(_core.Events.PLAYBACK_PLAY, this.name);
  ...
  Flash.prototype.pause = function pause() {
    ...
    this.el.playerPause();
    this.trigger(_core.Events.PLAYBACK_PAUSE, this.name);
  };
  ...
  Flash.prototype.seek = function seek(time) {
    ...
    if (this.isReady && this.el.playerSeek) {
      ...
      this.trigger(_core.Events.PLAYBACK_TIMEUPDATE, { current: time, total: this.el.getDuration() }, this.name);
...
Flash.canPlay = function (resource) {
  if (!_core.Browser.hasFlash || !resource || resource.constructor !== String) {
    return false;
  } else {
    var resourceParts = resource.split('?')[0].match(/.*\.(.*)$/) || [];
    return resourceParts.length > 1 && !_core.Browser.isMobile && resourceParts[1].toLowerCase().match(/^(mp4|mov|f4v|3gpp|3gp)$/);
  }
};
module.exports = exports['default'];
...
//# sourceMappingURL=flash-playback.js.map
...
var _flashPlayback = __webpack_require__(/*! @clappr/flash-playback */ "./node_modules/@clappr/flash-playback/dist/flash-playback.js");
...
//# sourceMappingURL=flashls-playback.js.map